<template>
    <div class="flex flex-col lg:flex-row gap-4 items-start">
        <StepSidebar
            ...
            current-key="minutes5"
        />
        <div class="bg-[#f3fbfb] border-4 border-black rounded-xl p-3.5 flex-1" id="mn_form5" data-sub="บันทึกการประชุม QCC #5">
        <!-- Title -->
        <div class="text-[26px] font-extrabold text-center my-1.5 leading-tight">
            บันทึกการประชุมกิจกรรมกลุ่ม <b>QCC</b><br />
            <span class="text-gray-500 font-semibold text-[0.9em]">Minutes of QCC Activity Meeting #5</span>
        </div>
        ...
        <div class="grid gap-2.5 items-center"
            ...
            <input v-model="state.place"
                class="w-full px-2.5 py-2 border-2 border-black rounded-xl bg-white disabled:bg-gray-100"
                :disabled="ui.disabled" placeholder="War Room" />
        ...
        <div class="flex gap-2 justify-end mt-3 items-center">
            ...
            <button class="border-2 border-black rounded-xl px-3.5 py-2 bg-white font-bold" @click="goBack">
                « ย้อนกลับ
            </button>
